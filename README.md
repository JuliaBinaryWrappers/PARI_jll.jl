# `PARI_jll.jl` (v2.17.3+0)

[![deps](https://juliahub.com/docs/PARI_jll/deps.svg)](https://juliahub.com/ui/Packages/General/PARI_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/be5882e7124747558aee0ecf3181d888ffe5c1e7/P/PARI/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `PARI_jll.jl` have been built from these sources:

* compressed archive: https://pari.math.u-bordeaux.fr/pub/pari/unix/pari-2.17.3.tar.gz (SHA256 checksum: `8d9c4fcd584c468d27e0f23c36836587284452094c4b1c404c20c4b810462dcb`)

## Platforms

`PARI_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `PARI_jll.jl`:
...
* `LibraryProduct`: `libpari`
* `ExecutableProduct`: `gp`
* `FileProduct`: `pari_desc`
